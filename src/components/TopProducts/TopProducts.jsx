...
const ProductsData = [
    {
        ...
        img: Img1,
        title: 'Casual Wear',
        description: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laboriosam eius harum quibusdam laborum, totam nesciunt."
    },
    {
        id: 2,
        img: Img2,
        ...
        <div>
            <div className='container'>
                ...
                <div className='text-left mb-24'>
                    ...
                    <p data-aos="fade-up" className='text-xs text-gray-400'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Blanditiis, debitis.</p>
                </div>
                        ...
                        ProductsData.map((data) => (
                            ...
                            duration-300 group max-w-[300px]'>
                                ...
                                <div className='h-[100px] '>
                                    <img src={data.img} alt="" className='max-w-[140px] block mx-auto transform 
